                    ...
                    @else
                        @foreach ($list as $item)
                            <tr>
                                ...
                                <td>{{ Str::limit($item->complaints_name, 30) }}</td>
                                <td>{{ $item->complaints_date_insert }}</td>
                                <td>
                                    @if ($item->complaints_status === 'N')
                                        <span class="badge bg-danger rounded-pill px-3 py-2">
                                            ● ยังไม่ได้ดำเนินการ
                                        </span>
                                    @elseif ($item->complaints_status === 'R')
                                ...
                                <td>
                                    <a href="{{ route('complaintdetail', ['menu' => $menuId, 'id' => $item->complaints_id]) }}">
