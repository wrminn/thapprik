                    ...
                    @else
                        @foreach ($list as $item)
                            <tr>
                                ...
                                <td>{{ Str::limit($item->contacts_name, 30) }}</td>
                                <td>{{ $item->contact_date_show_buddhist }}</td>
                                <td>
                                    @if ($item->contacts_status === 'N')
                                        <span class="badge bg-danger rounded-pill px-3 py-2">
                                            ● ยังไม่ได้ดำเนินการ
                                        </span>
                                    @elseif ($item->contacts_status === 'R')
                                ...
                                <td>
                                    <a href="{{ route('contactdetail', ['menu' => $menuId, 'id' => $item->contacts_id]) }}">
