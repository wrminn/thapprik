            ...
            <table class="table caption-top" id="myTable">
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col"class="col-3" style="width: 15%;">สถานะแบบฟอร์ม</th>
                    ...
                    @else
                        @foreach ($list as $item)
                            <tr>
                                ...
                                <td>{{ Str::limit($item->corruptions_name, 30) }}</td>
                                <td>{{ $item->corruptions_date_insert }}</td>
                                <td>
                                    @if ($item->corruptions_status === 'N')
                                        <span class="badge bg-danger rounded-pill px-3 py-2">
                                            ● ยังไม่ได้ดำเนินการ
                                        </span>
                                    @elseif ($item->corruptions_status === 'R')
                                ...
                                <td>
                                    <a href="{{ route('corruptiondetail', ['menu' => $menuId, 'id' => $item->corruptions_id]) }}">
