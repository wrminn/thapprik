                ...
                <caption>
                    <div class="row">
                        ...
                        <div class="col-md-1 ms-auto">
                            <a href="/backend/addelibrary/menu/{{ $menuId }}"><button type="button"
                    ...
                    @else
                        @foreach ($list as $item)
                            <tr>
                                ...
                                <td>{{ Str::limit($item->elibrary_title, 30) }}</td>
                                <td>
                                    <a href="{{ route('elibraryone', ['menu' => $menuId, 'id' => $item->elibrary_id]) }}">
                                    ...
                                    <button type="button" class="btn btn-outline-danger"
                                        onclick="deleteItem('{{ route('deleteelibraryid', ['menu' => $menuId, 'id' => $item->elibrary_id]) }}')">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="12" height="12"
