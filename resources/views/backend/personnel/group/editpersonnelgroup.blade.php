    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="" action="{{ route('editpersonnelonegroup', ['menu' => $menuId, 'id' => $id]) }}"
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <label for="slot" class="form-label">รูป
                                    @if (!empty($list->personnelgroup_path))
                                        <img src="{{ asset('storage/' . $list->personnelgroup_path) }}" width="30%"
                                            accept="image/*">
                                    @endif
                                </label>
                                <input type="file" class="form-control" name="personnelgroup_img">
                            </div>
                        </div>
                    </div>
