    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="" action="{{ route('popup.insert', ['menu' => $menuId]) }}" method="post"
                    enctype="multipart/form-data">
                    @csrf

                    @if (!empty($list->popup_path))
                        <img src="{{ asset('storage/' . $list->popup_path) }}" width="10%">
                    @endif

                    <div class="col">
                        <div class="mb-3">
                            <label for="slot" class="form-label">ภาพ</label>
