            ...
            <table class="table caption-top" id="myTable">
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col"class="col-2" style="width: 50%;">เรื่อง</th>
                        <th scope="col"class="col-2" style="width: 14%;">วันที่</th>
                    ...
                    @else
                        @foreach ($list as $item)
                            <tr>
                                ...
                                <td>{{ Str::limit($item->threads_name, 30) }}</td>
                                <td>{{ $item->threads_date_show }}</td>
                                <td>
                                    <a href="{{ route('threaddetail', ['menu' => $menuId, 'id' => $item->threads_id]) }}">
                                ...
                                <td>
                                    ...
                                    @if ($item->threads_status == 'O')
                                        <a href="{{ route('hidethread', ['menu' => $menuId, 'id' => $item->threads_id]) }}">
                                    ...
                                    @else
                                        <a href="{{ route('openthread', ['menu' => $menuId, 'id' => $item->threads_id]) }}">
                                    ...
                                    <a href="{{ route('deletethread', ['menu' => $menuId, 'id' => $item->threads_id]) }}"
                                        onclick="return confirm('ต้องการลบบทความหรือไม่')">
                                        <button type="button" class="btn btn-outline-danger btn-sm" fdprocessedid="2gfdil">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="12" height="12"
